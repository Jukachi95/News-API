...
let url = 'https://newsapi.org/v2/top-headlines?country=us&apiKey=679e46cfd8644d3297d67576874a835c'
...
// Render UK Sports
  ...
  let UKSportBtn = document.getElementById('generateSportUK');


  UKSportBtn.addEventListener('click', renderUKSports);



  function renderUKSports(){

    let UKSportsUrl = 'https://newsapi.org/v2/top-headlines?country=gb&category=sports&apiKey=679e46cfd8644d3297d67576874a835c';
